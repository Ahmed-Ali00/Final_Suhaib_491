...
public class Quiryphp extends AsyncTask<String,Void,String> {
    ...
    private String onInsert(String ... params){
        String phpPageULR="http://172.20.10.9:80/sqli/mysql_write.php";
        try {
...
//Delete users in php
    ...
    private String onSearch(String ... params){
        ...
        // if serch corect go to page ruselt and return the answer
        return result;
    }
