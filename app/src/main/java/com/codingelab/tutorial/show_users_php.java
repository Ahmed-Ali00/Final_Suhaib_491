...
public class show_users_php extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_users_php);
    ...
    private class GetUsersTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String newsUrl = "http://172.20.10.9:80/sqli/getData.php";
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null) {
                Toast.makeText(show_users_php.this, "Error connect to Server", Toast.LENGTH_SHORT).show();
                return;
            }
               ...
               // JSONObject rootJSON = new JSONObject(s);
                ...
                //if (rootJSON.getInt("status") == 1) {
                   ...
                   // JSONArray usersArray = rootJSON.getJSONArray("usersPhp");
                    ...
                    UsersAdapter mUsersAdapter = new UsersAdapter(show_users_php.this, users);
