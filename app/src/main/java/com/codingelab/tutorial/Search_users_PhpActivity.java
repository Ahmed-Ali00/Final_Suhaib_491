...
public class Search_users_PhpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_users_php);

        this.syn=new Quiryphp();
                    ...
                    public void onClick(View v) {
                      ...
                      //  task.execute();
                        ...
                        try {
                            ...
                            UsersAdapter mUsersAdapter = new UsersAdapter(Search_users_PhpActivity.this, users);
                            listUsers.setAdapter(mUsersAdapter);

              /*  } else {

                    Toast.makeText(show_users_php.this, rootJSON.getString("msg"), Toast.LENGTH_SHORT).show();
                }*/
    ...
    private class GetUsersTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String newsUrl = "http://172.20.10.9:80/sqli/mysql_write.php";
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null) {
                Toast.makeText(Search_users_PhpActivity.this, "Error connect to Server", Toast.LENGTH_SHORT).show();
                return;
            }
